export default [
  "fa-solid fa-icons fa-fw fa-2x",
  "fa-sharp fa-solid fa-icons fa-fw fa-2x",
  "fa-brands fa-font-awesome-flag fa-fw fa-2x",
  "fa fa-bolt fa-fw fa-2x",
  "fas fa-universal-access fa-fw unchecked-icon",
  "fas fa-cat fa-fw unchecked-icon",
  "fas fa-square-up-right fa-fw unchecked-icon",
  "fas fa-car-side fa-fw unchecked-icon",
  "fas fa-landmark fa-fw unchecked-icon",
  "fas fa-briefcase fa-fw unchecked-icon",
  "fas fa-chart-simple fa-fw unchecked-icon",
  "fas fa-t-shirt fa-fw unchecked-icon",
  "fas fa-code fa-fw unchecked-icon",
  "fas fa-person-digging fa-fw unchecked-icon",
  "fas fa-palette fa-fw unchecked-icon",
  "fas fa-burst fa-fw unchecked-icon",
  "fas fa-graduation-cap fa-fw unchecked-icon",
  "fas fa-face-grin-wink fa-fw unchecked-icon",
  "fas fa-bolt fa-fw unchecked-icon",
  "fas fa-film fa-fw unchecked-icon",
  "fas fa-venus-mars fa-fw unchecked-icon",
  "fas fa-hand-paper fa-fw unchecked-icon",
  "fas fa-parachute-box fa-fw unchecked-icon",
  "fas fa-truck-fast fa-fw unchecked-icon",
  "fas fa-map fa-fw unchecked-icon",
  "fas fa-anchor fa-fw unchecked-icon",
  "fas fa-stethoscope fa-fw unchecked-icon",
  "fas fa-music fa-fw unchecked-icon",
  "fas fa-camera-retro fa-fw unchecked-icon",
  "fas fa-check-double fa-fw unchecked-icon",
  "fas fa-quote-left fa-fw unchecked-icon",
  "fas fa-person-praying fa-fw unchecked-icon",
  "fas fa-shield fa-fw unchecked-icon",
  "fas fa-shapes fa-fw unchecked-icon",
  "fas fa-bag-shopping fa-fw unchecked-icon",
  "fas fa-hashtag fa-fw unchecked-icon",
  "fas fa-rotate fa-fw unchecked-icon",
  "fas fa-heart-pulse fa-fw unchecked-icon",
  "fas fa-calendar-days fa-fw unchecked-icon",
  "fas fa-toggle-on fa-fw unchecked-icon",
  "fas fa-spa fa-fw unchecked-icon",
  "fas fa-cloud-sun fa-fw unchecked-icon",
  "fas fa-cloud-arrow-up fa-fw fa-4x",
